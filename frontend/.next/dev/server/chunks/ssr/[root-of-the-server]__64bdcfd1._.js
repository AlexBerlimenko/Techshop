    ...
    async function loadData() {
        ...
        try {
            if (activeTab === 'orders') {
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].products.getAll();
                if (response.success && response.data) {
                    setProducts(response.data.map((p)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertBackendProductToFrontend"])(p)));
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__64bdcfd1._.js.map