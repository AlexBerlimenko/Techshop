...
function AdminPage() {
        ...
        "AdminPage.useEffect": ()=>{
            const checkAuth = {
                "AdminPage.useEffect.checkAuth": async ()=>{
                    // Даємо час на ініціалізацію автентифікації через AuthInit
                    await new Promise({
                        "AdminPage.useEffect.checkAuth": (resolve)=>setTimeout(resolve, 1000)
                    ...
                    setAuthChecked(true);
                    if (!token) {
                        console.log('AdminPage: No token, redirecting to /auth');
                        window.location.href = '/auth';
                        return;
                    }
                    // Перевіряємо стан після затримки
                    ...
                    if (!isAuthenticated || !user || user.role !== 'admin') {
                        console.log('AdminPage: Not admin, redirecting to /auth');
                        window.location.href = '/auth';
                        return;
                    }
    ...
    // Редирект якщо не адмін після перевірки
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPage.useEffect": ()=>{
            if (authChecked && (!isAuthenticated || !user || user.role !== 'admin')) {
                console.log('AdminPage: Redirecting to /auth from second useEffect');
                window.location.href = '/auth';
            }
        }
    }["AdminPage.useEffect"], [
    ...
    async function loadData() {
        ...
        try {
            if (activeTab === 'orders') {
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].products.getAll();
                if (response.success && response.data) {
                    setProducts(response.data.map((p)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertBackendProductToFrontend"])(p)));
                }
    ...
    // Перевірка після завантаження автентифікації
    if (authChecked && (!isAuthenticated || !user || user.role !== 'admin')) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "min-h-screen bg-loki-black flex items-center justify-center",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(AdminPage, "VjrBqOb3fhRaXZxm3Am016mQk8I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"]
    ];
...
//# sourceMappingURL=_08920177._.js.map